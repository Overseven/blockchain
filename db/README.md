...
- в противном случае
  - запрашиваем по N блоков (только его хэш и хэш предыдущего блока) в обратном порядке начиная с 12 блока, ищем блок, с которого начинается расхождение
  ...
  - добавляем во временную область бд (temp) балансы, голосования из блоков __ЛБ__ с 5 < id <= 9 // __TODO:__ что именно нужно сохранять?
